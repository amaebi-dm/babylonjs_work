...
export function CreateMovingButtons( advTex : GUI.AdvancedDynamicTexture, camera : UniversalCamera )
{
  ...
  advTex.addControl( buttonTOP );
  advTex.addControl( buttonBOTTOM );
  advTex.addControl( buttonLEFT );
  advTex.addControl( buttonRIGHT );
  advTex.addControl( buttonFRONT );
  advTex.addControl( buttonBACK );
  advTex.addControl( buttonCENTER );

  advTex.addControl( buttonTOPROT );
  advTex.addControl( buttonBOTTOMROT );
  advTex.addControl( buttonLEFTROT );
  advTex.addControl( buttonRIGHTROT );
}

  
export function OnCameraUpdate( camera : UniversalCamera )
{
